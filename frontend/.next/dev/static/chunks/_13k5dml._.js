...
"[project]/src/app/receptionist/page.jsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ReceptionistDashboard() {
    ...
    // State for the room selector
    const [myRoom, setMyRoom] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('Room 1');
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ReceptionistDashboard.useEffect": ()=>{
            const handleKeyDown = {
                "ReceptionistDashboard.useEffect.handleKeyDown": async (e)=>{
                    if (e.code === 'Space' && e.target.tagName !== 'INPUT') {
                        e.preventDefault();
                        callNextPatient();
                    }
                }
            }["ReceptionistDashboard.useEffect.handleKeyDown"];
            window.addEventListener('keydown', handleKeyDown);
            return ({
                "ReceptionistDashboard.useEffect": ()=>window.removeEventListener('keydown', handleKeyDown)
            })["ReceptionistDashboard.useEffect"];
        }
    }["ReceptionistDashboard.useEffect"], [
        myRoom
    ]); // Added myRoom to dependency array so the spacebar uses the correct room
    const addPatient = async (e_0)=>{
        e_0.preventDefault();
    ...
    const callNextPatient = async ()=>{
        const res = await fetch('http://localhost:5000/api/queue/next', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
            // WE NOW PASS THE SELECTED ROOM TO THE BACKEND
            body: JSON.stringify({
                clinicId,
                roomNumber: myRoom
            })
        ...
        if (data.activeToken) setActiveToken(data.activeToken.tokenNumber);
    };
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-white/70 backdrop-blur-xl border border-white/50 shadow-sm rounded-3xl p-8 flex flex-col justify-center",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$user$2d$plus$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__UserPlus$3e$__["UserPlus"], {
                                    ...
                                    fileName: "[project]/src/app/receptionist/page.jsx",
                                    lineNumber: 59,
                                    columnNumber: 13
                                }, this),
                                " Queue Entry"
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("form", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                ...
                                value: patientName,
                                onChange: (e_1)=>setPatientName(e_1.target.value),
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "text-xs text-slate-400 mt-4 font-medium tracking-wide uppercase",
                            children: "Sub-3 Second Workflow Enabled"
                        }, void 0, false, {
                            fileName: "[project]/src/app/receptionist/page.jsx",
                            lineNumber: 64,
                            columnNumber: 11
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "bg-gradient-to-br from-blue-500 to-indigo-600 shadow-xl rounded-3xl p-8 text-white flex flex-col items-center justify-center relative overflow-hidden",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "text-8xl font-bold tracking-tighter mb-8",
                            children: activeToken ? `#${activeToken}` : '--'
                        }, void 0, false, {
                            fileName: "[project]/src/app/receptionist/page.jsx",
                            lineNumber: 73,
                            columnNumber: 11
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                value: myRoom,
                                onChange: (e_2)=>setMyRoom(e_2.target.value),
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                        ...
                                        children: "Assign to Doctor A (Room 1)"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/receptionist/page.jsx",
                                        lineNumber: 80,
                                        columnNumber: 15
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                        value: "Room 2",
                                        className: "text-slate-800 font-medium",
                                        children: "Assign to Doctor B (Room 2)"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/receptionist/page.jsx",
                                        lineNumber: 81,
                                        columnNumber: 15
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                        value: "Room 3",
                                        className: "text-slate-800 font-medium",
                                        children: "Assign to Doctor C (Room 3)"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/receptionist/page.jsx",
                                        lineNumber: 82,
                                        columnNumber: 15
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "mt-4 text-blue-200 text-sm z-10",
                            children: [
                                "Or press ",
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("kbd", {
                                    className: "bg-blue-800/30 px-2 py-1 rounded text-white font-mono text-xs",
                                    children: "Spacebar"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/receptionist/page.jsx",
                                    lineNumber: 89,
...
_s(ReceptionistDashboard, "sSJrWA7mfKVYSKWXmfuXbdYDUEU=");
...
//# sourceMappingURL=_13k5dml._.js.map